        ...
        return (
            <div>
                ...
                {/* <Row type="flex" justify="space-around" align="middle">
                    <Col xs={{ span: 3, offset: 1 }} lg={{ span: 3, offset: 1 }}><img src={world} alt="Adventrue" style={{ width: 80, height: 80 }} /><br />Adventrue</Col>
                    <Col xs={{ span: 3, offset: 1 }} lg={{ span: 3, offset: 1 }}><img src={palm} alt="Nature" style={{ width: 80, height: 80 }} /><br />Water Activities</Col>
                    <Col xs={{ span: 3, offset: 1 }} lg={{ span: 3, offset: 1 }}><img src={pray} alt="Religion" style={{ width: 80, height: 80 }} /><br />Religion</Col>
                    <Col xs={{ span: 3, offset: 1 }} lg={{ span: 3, offset: 1 }}><img src={mountain} alt="Mountain" style={{ width: 80, height: 80 }} /><br />Mountain</Col>
                </Row> , */}
                < br />
                <br />
                <br />
